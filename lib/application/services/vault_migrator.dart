class VaultMigrator {
  ...
  static const int currentVaultFormatVersion = 1;
  ...
  static Map<String, dynamic> migrateVaultFileJson(Map<String, dynamic> input) {
    ...
    if (version > currentVaultFormatVersion) {
      throw UnsupportedError('Vault format version $version is not supported by this app build.');
    }
  ...
  static Map<String, dynamic> migratePayloadJson(Map<String, dynamic> input) {
    ...
    if (version > currentPayloadSchemaVersion) {
      throw UnsupportedError('Vault payload schema version $version is not supported by this app build.');
    }
